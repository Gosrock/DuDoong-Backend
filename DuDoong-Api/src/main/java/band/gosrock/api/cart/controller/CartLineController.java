...
//    }
    ...
    @PostMapping("/add")
    public void createCartLines(@RequestBody @Valid AddCartRequest addCartRequest) {
        createCartLinesUseCase.execute(addCartRequest);
    }
...
//    public void getItemOptions(@PathVariable("cart_id") Long cartId,@PathVariable("line_id") Long ticketItemId) {
//        createOrderLineUseCase.execute(ticketItemId);
//    }
