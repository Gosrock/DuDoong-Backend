...
public enum OrderErrorCode implements BaseErrorCode {
    ...
    ORDER_NOT_MINE(BAD_REQUEST, "Order-400-1", "본인의 주문이 아닙니다."),
    @ExplainError("토스 결제 금액과 , 주문금액이 다를 때 등 올바르지 않은 주문 상태를 가질 때 발생하는 오류입니다.")
    ORDER_NOT_VALID(BAD_REQUEST, "Order-400-2", "올바르지 않은 주문입니다."),
    ORDER_NOT_PENDING(BAD_REQUEST, "Order-400-3", "결제,승인 대기중인 주문이 아닙니다."),
    ORDER_NOT_SUPPORTED_METHOD(BAD_REQUEST, "Order-400-4", "지원하지 않는 방식의 주문입니다."),
    ...
    ORDER_NOT_FOUND(NOT_FOUND, "Order-404-1", "주문을 찾을 수 없습니다."),
    ORDER_LINE_NOT_FOUND(NOT_FOUND, "Order-404-2", "주문 라인을 찾을 수 없습니다.");
