...
@ExceptionDoc
public class CancelOrderExceptionDocs implements SwaggerExampleExceptions {
    ...
    public DuDoongCodeException 주문상태_취소가능_검증 = CanNotCancelOrderException.EXCEPTION;
